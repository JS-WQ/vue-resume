...
export default {
  ...
  methods: {
    ...
    keepDate: function() {
      ...
      irusmer.setACL(acl);
      irusmer.set("profile", this.iresum.profile);
      irusmer.set("WorkExperience", this.iresum.WorkExperience);
      irusmer.set("StudyExperience", this.iresum.StudyExperience);
      irusmer.set("Projects", this.iresum.Projects);
      irusmer.set("Awards", this.iresum.Awards);
      irusmer.set("telephone", this.iresum.telephone);
      irusmer.set("selfAppraisal", this.iresum.selfAppraisal);
      irusmer.set("vocationalSkills", this.iresum.vocationalSkills);
      irusmer.save();
    }
  },
  computed: {},
