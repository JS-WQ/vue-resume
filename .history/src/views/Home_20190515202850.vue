<template>
  <div class="home" ref="home">
    <vheader @toPreview="toPreview" @setSignshow='setSignshow' :state='state' :resume='resume'></vheader>
    ...
    <vsignbox @getData="getData" v-if="signShow" :status='status' @setSignshow='setSignshow'></vsignbox>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    //设置登录框是否显示
    setSignshow:function(status,state){
      if(status === 'hidden'){
        this.signShow = false
